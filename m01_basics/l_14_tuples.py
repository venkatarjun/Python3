...
#t=(1,2,3,4) ------>this is tuple---->()----->we cant append anyextra item laterie immutable
#we can convert tuple to list vice versa like l=tupule(list)
# --- Main program --------------------------------------------
if __name__ == '__main__':
    ...
    #here () repr tupule
    print("  name:", device[0])    #closing with tupule observe
